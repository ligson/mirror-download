...
echo "$RUN_JAVA -Dfile.encoding=UTF-8 -classpath $LIB_PATH org.ligson.mirrordownload.AppBoot"
#export LD_LIBRARY_PATH='$LD_LIBRARY_PATH:$WORK_HOME/tools/lib'
nohup $RUN_JAVA -Dfile.encoding=UTF-8 -classpath $LIB_PATH org.ligson.mirrordownload.AppBoot >>mirror-download.log 2>1&
